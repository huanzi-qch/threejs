...
export class EarthService {
    ...
    public initAnimate(): void {
        ...
        thid.sceneService.cameraInspect(-0.5,new THREE.Vector3(40, oldPosition.y, oldPosition.z),function () {
    ...
    private kfCloudAnimate(callback ?: () => void): void {
        ...
        this.sceneService.controls.minDistance = 0;//最小缩放
        this.sceneService.controls.maxDistance = 8000;//最大缩放
        ...
        //再推进镜头
        thid.sceneService.cameraInspect(-10,new THREE.Vector3(-550, -550, 0),function () {
            //删除云海
            // 递归遍历组对象group释放所有后代网格模型绑定几何体占用内存
